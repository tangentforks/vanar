...
# MODULE:      Backend interface for compiling the AVM level 2 ISA to
#              machine-code for AMD64 compatible processors
# -----------------------------------------------------------------------------
...
#   navmCpuType:      Can either be set to CISC, RISC, MISC or VLIW
#   navmCpuDecoder:   Possible settings are out-of-order,in-order or serial
#   navmCpuWordSize:  The word-size for values in byte
#   navmCpuAdrSize:   The address word-size in byte
#   navmCpuBigEndian: Endianess, true for big endian and false for little endian
